...
FANED_VAR(calclightradius, 0, 0, INT_MAX);    //faned
...
static void generatelightmaps(cube *c, int cx, int cy, int cz, int size)
{
    ...
    loopi(8)
    {
        ...
        if ((calclightradius > 0)
           && (size < calclightradius / 2)
              && ((o.x-game::player1->o.x)
                * (o.x-game::player1->o.x)
                + (o.y-game::player1->o.y)
                * (o.y-game::player1->o.y)
                + (o.z-game::player1->o.z)
                * (o.z-game::player1->o.z)
                > calclightradius * calclightradius))
            return;    //faned
        if(c[i].children)
