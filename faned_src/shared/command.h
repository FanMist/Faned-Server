...
enum { IDF_PERSIST = 1<<0, IDF_OVERRIDE = 1<<1, IDF_HEX = 1<<2, IDF_READONLY = 1<<3, IDF_OVERRIDDEN = 1<<4, IDF_UNKNOWN = 1<<5, IDF_ARG = 1<<6, IDF_FANED = 1<<7 };    //faned
...
//start faned
#define FANED_FVARP(name, min, cur, max) _FVAR(name, name, min, cur, max, IDF_PERSIST|IDF_FANED)
#define FANED_HVARFP(name, min, cur, max, body) _HVARF(name, name, min, cur, max, body, IDF_PERSIST|IDF_FANED)
#define FANED_HVARP(name, min, cur, max) _HVAR(name, name, min, cur, max, IDF_PERSIST|IDF_FANED)
#define FANED_SVARFP(name, cur, body) _SVARF(name, name, cur, body, IDF_PERSIST|IDF_FANED)
#define FANED_SVAR(name, cur) _SVAR(name, name, cur, 0|IDF_FANED)
#define FANED_SVARP(name, cur) _SVAR(name, name, cur, IDF_PERSIST|IDF_FANED)
#define FANED_VAR(name, min, cur, max) _VAR(name, name, min, cur, max, 0|IDF_FANED)
#define FANED_VARP(name, min, cur, max) _VAR(name, name, min, cur, max, IDF_PERSIST|IDF_FANED)
//end faned
